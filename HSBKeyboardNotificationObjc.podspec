...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of HSBKeyboardNotificationObjc.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'HSBKeyboardNotificationObjc/Classes/**/*'
  
  # s.resource_bundles = {
  #   'HSBKeyboardNotificationObjc' => ['HSBKeyboardNotificationObjc/Assets/*.png']
  # }
